...
public class PostControllerTest {
    ...
    @Test
    @WithAnonymousUser
    void post_deleteWithNoLogin() throws Exception {
    ...
    @Test
    @WithMockUser
    void post_deleteWithAnotherUser() throws Exception{
    ...
    @Test
    @WithMockUser
    void post_deleteWithNoPosts() throws Exception{
    ...
    @Test
    @WithMockUser
    void post_search() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void post_searchWithnoLogin() throws Exception {
        when(postService.list(any())).thenReturn(Page.empty());
    ...
    @Test
    @WithMockUser
    void post_searchMyFeed() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void post_searchMyFeedWithNoLogin() throws Exception {
        when(postService.my(any(), any())).thenReturn(Page.empty());
    ...
    @Test
    @WithAnonymousUser
    void post_commentWithNoLogin() throws Exception {
        mockMvc.perform(post("/api/v1/posts/1/comments")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsBytes(new PostCommentRequest("comment")))
                ).andDo(print())
    ...
    @Test
    @WithMockUser
    void post_commentWithNoPosts() throws Exception {
